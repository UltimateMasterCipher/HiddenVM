...
install_packages() {
    ...
    #   ebtables was added for testing purposes to fix a firewall issue with libvirt
    log "Install packages, prog-id=9"
    sudo apt-get -q -y ${APT_OPTS_FOR_VMANAGER} install make bindfs dpkg-dev qemu-kvm libvirt-daemon-system libvirt-clients gir1.2-spiceclientgtk-3.0 dnsmasq qemu-utils ebtables
